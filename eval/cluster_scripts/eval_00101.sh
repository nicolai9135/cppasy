...
directory_recursion () {
    ...
    if [ $smt2_count -ge 1 ]; then 
	    ...
	    feature_folder_name="$benchmark_folder_name/00101"
		...
		timeout $timeout_val /home/nicolai.radke/master_thesis/cppasy-main/eval/scripts/evaluate_single.sh $smt2_file $depth 0 0 1 0 1 > $output_file_name
