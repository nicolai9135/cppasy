...
for current_depth in range(max_depth):
    ...
    print("Single Depth Data Shape: ", np.shape(single_depth_data))
    print("-> timeouts:  ", timeout_count)
    print("-> valid:     ", len(single_depth_list))

    if current_depth <= 6:
        all_data_to_6_list.append(single_depth_data)

all_data_to_6 = np.array(all_data_to_6_list)

print(all_data_to_6.shape)
# np.save("data6.npy", all_data_to_6)
